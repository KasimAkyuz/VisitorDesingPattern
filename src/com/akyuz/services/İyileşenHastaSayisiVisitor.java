...
public class İyileşenHastaSayisiVisitor implements Visitor {
	...
	private int hastaSayisiHesapla(Hastane hastane) {
		return HastaHesaplaUtil.hastaSayisiHesapla(hastane, EnumHastalik.COVİD,EnumHastaDurumu.İYİLEŞTİ);
